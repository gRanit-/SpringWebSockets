...
import pl.itdccs.websocket.web.entities.RegistrationForm;
import pl.itdccs.websocket.web.entities.SocialMediaService;
...
public class RegistrationController {
	...
	public String registerUserAccount( @ModelAttribute("user") RegistrationForm userAccountData,
